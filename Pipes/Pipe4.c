...
/* Asignamos el descriptor de lectura del pipe almacenado en pdf[0] al STDIN, y cerramos el descriptor de escritura en el proceso hijo */
    if(dup(pfd[0]) == -1 || close(pfd[1]) == -1) perror("close");
